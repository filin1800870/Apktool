...
import com.android.apktool.fragment.EditorFragment;
import com.android.apktool.fragment.FilesFragment;
import com.android.apktool.fragment.editor.EditorPagerAdapter;
import com.android.apktool.util.Settings;
import com.android.apktool.fragment.files.*;
import java.io.*;
...
public class MainActivity extends ThemedActivity implements DrawerLayout.DrawerListener
{
	...
	{
		String data=getFilesDir().getParent();
		String sdcard=Environment.getExternalStorageState();
		String home=Settings.getProjectPath();
		if (home.contains(data))
		{
			Data.home = sdcard;
		}
		else
		...
		Settings.setProjectPath(Data.home, MainActivity.this);
		e.putString("project_path", Data.home);
		e.commit();
		files.setPage(0);
	}
}
